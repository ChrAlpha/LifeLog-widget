...
import TimeDisplayContainer from "@/components/ui/TimeDisplayContainer"; // Import the new container
                ...
                {gridData.map((row, rowIndex) =>
                    row.map((cell, colIndex) => (
                        <div
                            ...
                            className={`w-3 h-3 rounded-sm ${cell === 0 ? "bg-gray-700" : cell === 1 ? "bg-white" : "bg-orange-500 animate-pulse"}`}
                        />
                    )),
                )}
            </div>
